    ...
    return [
      ...
      },
      {
        ...
        headers: [
          ...
          { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://unpkg.com https://cdn.jsdelivr.net https://www.googletagmanager.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.tailwindcss.com; font-src 'self' https://fonts.gstatic.com https://qirbapivptotybspnbet.supabase.co; img-src 'self' data: https: blob:; connect-src 'self' https://qirbapivptotybspnbet.supabase.co wss://qirbapivptotybspnbet.supabase.co https://api.unsplash.com https://www.googletagmanager.com https://www.google-analytics.com; frame-ancestors 'none'; object-src 'none'; base-uri 'self'; form-action 'self' https://pay.sandbox.kaja-gateway.com https://pay.kaja-gateway.com;" },
        ],
      },
      {
        source: "/fonts/:path*",
