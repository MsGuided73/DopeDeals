...
async function createCarouselTableDirect(): Promise<void> {
  ...
  try {
    ...
    const initialSlides = [
      ...
      {
        id: crypto.randomUUID(),
        title: 'PREMIUM DAB-RIGS BY PUFFCO',
        subtitle: 'WHEN ONLY THE BEST WILL DO',
        description: 'Experience smooth and flavorful tokes with the PUFFCO Pro V2 - For the ultimate "Cannaseur"',
        cta_text: 'SHOP DAB-RIGS',
        cta_link: '/dab-rigs',
