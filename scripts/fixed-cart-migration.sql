-- Fixed Cart System Migration (Compatible with existing products table)
...
CREATE TABLE IF NOT EXISTS shopping_cart (
  ...
  product_id TEXT NOT NULL, -- Changed from UUID to TEXT
...
-- Add foreign key constraint manually (after table creation)
...
CREATE TABLE IF NOT EXISTS order_items (
  ...
  product_id TEXT, -- Changed from UUID to TEXT, nullable since product might be deleted
...
-- Add foreign key constraint for order_items (optional since product might be deleted)
