...
export default function DabsntoolsHero({ activeCategory, setActiveCategory }: DabsntoolsHeroProps) {
  return (
    <CategoryHero
      ...
      illustrationSrc="https://qirbapivptotybspnbet.supabase.co/storage/v1/object/public/Highway420_assets/Product_Pages/New/Dab%20product%20page%20B.png"
      illustrationAlt="Highway 420 dabs — glass rigs, e-rigs, portable devices, and dab tools"
      pills={DABS_PILLS}
