...
interface DabsntoolsProductGridProps {
  ...
  if (products.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No concentrate equipment found</h3>
            ...
            <div className="flex">
              ...
              <div className="flex-1 p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {product.type && (
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-dope-orange-100 text-dope-orange-800">
                      {product.type}
                    </span>
                  )}
                  {product.size && (
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">
                  {product.short_description || product.description || 'Premium concentrate equipment for the ultimate dabbing experience.'}
                </p>

                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-2xl font-bold text-gray-900 dark:text-white">${product.price || product.our_price}</span>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                  <button
                    ...
                    className="w-full px-4 py-2 bg-dope-orange-600 hover:bg-dope-orange-700 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
