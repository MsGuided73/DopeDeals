  ...
  try {
    ...
    const transformedProducts = (data || []).map((product: any) => {
      ...
      return {
        ...
        id: product.id,
        name: product.name,
        price: (product.sale_price && parseFloat(product.sale_price) < parseFloat(product.price || 0)) ? parseFloat(product.sale_price) : parseFloat(product.price || 0),
        vip_price: product.fire_price ? parseFloat(product.fire_price) : undefined,
        compare_at_price: (product.sale_price && parseFloat(product.sale_price) < parseFloat(product.price || 0)) ? parseFloat(product.price || 0) : undefined,
