  ...
  try {
    ...
    const { data: rawProducts, error } = await supabase
      ...
      .or(`
        ...
        name.ilike.%nangs%,
        name.ilike.%balloon%,
        brand_name.ilike.%Doodlez%,
        brand_name.ilike.%Savage%,
        brand_name.ilike.%Best%Whip%,
        brand_name.ilike.%Whip%Trip%,
        brand_name.ilike.%Infuzed%,
        brand_name.ilike.%NOS%,
        brand_name.ilike.%Nitrous%,
        brand_name.ilike.%Whip%,
        category_slug.ilike.%nitrous%,
        category_slug.ilike.%n2o%,
        category_slug.ilike.%nos%,
        category_slug.ilike.%whip%,
        subcategory_slug.ilike.%nitrous%,
        subcategory_slug.ilike.%n2o%,
        subcategory_slug.ilike.%nos%,
        subcategory_slug.ilike.%whip%,
        categories.cs.["nitrous"],
        categories.cs.["n2o"],
        categories.cs.["nos"],
        categories.cs.["whip"],
        description.ilike.%nitrous%,
        description.ilike.%n2o%,
        description.ilike.%laughing%,
        description.ilike.%whip%,
        description.ilike.%cream%,
        description.ilike.%charger%
      `)
