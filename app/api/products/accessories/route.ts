...
export async function GET(req: NextRequest) {
  try {
    ...
    // Query accessories from main_site_products table
    // Search name, brand_name, and description for accessory-related terms
    // IMPORTANT: Only include products with valid image_url
    ...
    return NextResponse.json({ error: 'Failed to fetch accessories', details: String(error) }, { status: 500 });
  }
}
