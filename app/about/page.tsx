      ...
      <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                  Founded with a passion for cannabis culture and premium quality, Highway 420 emerged 
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Today, Highway 420 stands as a beacon for enthusiasts who demand authenticity, 
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                The principles that guide everything we do at Highway 420
              </p>
            </div>
        ...
        <section className="py-16 bg-white dark:bg-gray-900">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                The passionate individuals behind Highway 420's success
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Highway 420 Founder</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Dedicated to ensuring every customer has an exceptional Highway 420 experience
                </p>
              </div>
        ...
        <section className="py-16 bg-gradient-to-r from-dope-orange-500 to-orange-600 text-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold mb-6">Join the Highway 420 Family</h2>
