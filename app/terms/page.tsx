...
export const metadata: Metadata = {
  ...
  description: 'Highway 420 Terms of Service - Legal terms and conditions for using our website and services.',
};
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-600 dark:text-gray-300 space-y-4">
                <p>
                  By accessing and using the Highway 420 website and services, you accept and agree to be 
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-600 dark:text-gray-300 space-y-4">
                <p>
                  Highway 420 sells smoking accessories, glass pieces, vaporizers, and related products. 
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-600 dark:text-gray-300 space-y-4">
                <p>
                  ...
                  the exclusive property of Highway 420 and its licensors. The service is protected by 
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-600 dark:text-gray-300 space-y-4">
                <p>
                  In no event shall Highway 420, nor its directors, employees, partners, agents, suppliers, 
