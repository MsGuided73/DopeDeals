...
export default function PipesHero({ activeCategory, setActiveCategory }: PipesHeroProps) {
  return (
    <CategoryHero
      ...
      illustrationSrc="https://qirbapivptotybspnbet.supabase.co/storage/v1/object/public/Highway420_assets/Product_Pages/New/Pipe%20product%20final.png"
      illustrationAlt="Highway 420 pipes — premium hand-blown spoons, sherlocks, and chillums"
      pills={PIPES_PILLS}
