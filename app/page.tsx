      ...
      <div>
        ...
        <main className="w-full px-0 py-0 -mt-8">
          ...
          <section className="mt-24 mb-16">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-display-twilight font-bold mb-4" style={{
        ...
        <section className="mt-24 mb-16">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-display-twilight font-bold mb-4" style={{
                letterSpacing: '-0.02em',
                color: '#000000'
              }}>
                HIGHER LEARNING
