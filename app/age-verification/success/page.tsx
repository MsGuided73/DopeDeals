...
function AgeVerificationSuccessContent() {
  ...
  return (
        <div className="min-h-screen bg-black flex items-center justify-center font-inter p-6 relative overflow-hidden">
          {/* Background Glows */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-dope-orange/10 blur-[120px] rounded-full pointer-events-none"></div>div>
              ...
              <div className="glassmorphic-dark rounded-[2rem] p-10 md:p-16 text-center max-w-lg w-full relative z-10 border border-white/10 shadow-2xl">
                {status === 'processing' && (
                    <div className="animate-in fade-in zoom-in duration-500">
                                ...
                                <h1 className="text-3xl font-display-twilight text-white uppercase tracking-[0.15em] mb-4 font-bold pr-4">Processing Verification</h1>h1>
                                <p className="text-white/60">Please wait while we securely process your results. You will be redirected shortly.</p>p>
                    </div>div>
                      )}
                ...
                {status === 'approved' && (
                    <div className="animate-in fade-in zoom-in duration-500">
                                ...
                                <h1 className="text-4xl font-display-twilight text-white uppercase tracking-[0.15em] mb-4 font-bold pr-4">Age Verified</h1>h1>
                                <p className="text-white/60 mb-8 max-w-sm mx-auto">Your identity has been confirmed. Redirecting back to checkout...</p>p>
                                <div className="w-full bg-white/10 h-1.5 rounded-full overflow-hidden">
                                              <div className="h-full bg-green-500 rounded-full animate-[progress_3s_ease-in-out_forwards]"></div>div>
                                </div>div>
                    </div>div>
                      )}
                ...
                {status === 'declined' && (
                    <div className="animate-in fade-in zoom-in duration-500">
                                ...
                                <h1 className="text-3xl font-display-twilight text-white uppercase tracking-[0.15em] mb-4 font-bold pr-4">Verification Failed</h1>h1>
                                <p className="text-white/60 mb-8">Unfortunately, we could not verify your age at this time. Please try again or contact support.</p>p>
                                <button
