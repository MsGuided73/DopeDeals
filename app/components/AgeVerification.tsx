      ...
      <div className="relative z-10 bg-black text-white p-12 rounded-2xl shadow-2xl max-w-2xl mx-4 border border-dope-orange/30">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-dope-orange hover:bg-orange-600 text-black font-black py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg text-lg uppercase tracking-wide"
          >
            HELL YEAH, I'M 21+
          </button>
