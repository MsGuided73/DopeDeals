  ...
  return (
    ...
    <div className="relative z-50 isolate w-full px-4 pt-1 pb-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-2">
          {categories.map((cat, i) => (
            <a
              key={i}
              href={cat.route}
              className="aspect-[4/3] rounded-2xl overflow-hidden shadow-md relative group hover:scale-101 transition-all duration-300 block -mx-[5px] -my-[4px]"
              style={{
      ...
      <div className="hidden lg:block w-full">
        <div className="grid grid-cols-4 gap-2 h-[65vh] max-h-[500px] w-full">
          <a
            href="/ride-with-us"
            className="col-span-2 row-span-2 rounded-2xl overflow-hidden shadow-lg relative group hover:scale-105 transition-transform duration-300 block bg-black -mx-[10px] -my-[8px]"
          >
          ...
          {categories.map((cat, i) => (
            <a
              key={i}
              href={cat.route}
              className="rounded-2xl overflow-hidden shadow-md relative group hover:scale-101 transition-all duration-300 block -mx-[5px] -my-[4px]"
              style={{
                boxShadow: "0 0 0 0 rgba(34, 197, 94, 0.7)",
                transition: "box-shadow 0.3s ease, transform 0.3s ease",
              }}
