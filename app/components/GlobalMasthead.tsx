  ...
  return (
    ...
    <header className="z-50 relative">
      ...
      <div>
        {/* Promotional Banner */}
        <div
          className="text-white px-4 py-2 text-center relative overflow-hidden"
        ...
        <div
          className="bg-black px-1 flex flex-col relative"
          style={{ minHeight: "140px" }}
        >
          {/* Top Row: Logo, Search, Actions */}
          <div className="flex items-center justify-between gap-2 py-2" style={{ height: "100px" }}>
            {/* Left: Logo */}
            <div className="flex-shrink-0 h-full flex items-center pl-4">
            ...
            {/* Right: Actions */}
            <div className="flex items-center gap-3 flex-shrink-0 mr-8 text-white">
              <Link
                href="/sitemap-page"
