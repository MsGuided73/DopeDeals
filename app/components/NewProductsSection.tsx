    ...
    return (
      <section className="mt-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-chalets font-bold text-gray-900 mb-4">
            NEW ARRIVALS
          </h2>
    ...
    return (
      <section className="mt-16">
        <div className="text-center mb-12">
          ...
          <p className="text-red-500 mt-6">Error loading new products: {error}</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="mt-16 bg-gray-50 dark:bg-gray-950 py-12">
      <div className="max-w-7xl mx-auto px-4">
        {/* Section Header */}
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-chalets font-bold text-gray-900 dark:text-white mb-4"
              style={{
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
            Discover our latest premium products - fresh off the shelves
          </p>
        </div>
            ...
            {productsToShow.slice(0, 10).map((product) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex-shrink-0 w-72 h-80 block"
                >
                  ...
                  <div className="p-4 flex flex-col h-full">
                    ...
                    <div className="mt-auto">
                      ...
                      <Link
                        href={`/product/${product.id}`}
                        className="block text-center px-4 py-2.5 bg-transparent text-green-600 border-2 border-green-600 font-bold rounded-full transition-all duration-300 text-sm font-highway uppercase tracking-wide hover:bg-green-600 hover:text-white hover:scale-105 hover:shadow-lg hover:shadow-green-600/25"
                        style={{
